...
template <int THREADS_PER_BLOCK, int LOGICAL_THREADS_PER_WARP>
static void ORIGINAL_CUB_WARP_SEGMENTED_PREFIXSUM(benchmark::State &state) {
  ...
  if (errors > 0) {
    printf("ORIGINAL_CUB_SEGMENTED_PREFIXSUM_16 does not agree with SEQUENTIAL! %d "
           "errors!\n",
           errors);
  } else {
...
BENCHMARK_TEMPLATE(ORIGINAL_CUB_WARP_SEGMENTED_PREFIXSUM, 32, 16)
    ->SEG_16_ARGS()
    ->UseManualTime();
BENCHMARK_TEMPLATE(ORIGINAL_CUB_WARP_SEGMENTED_PREFIXSUM, 64, 16)
    ->SEG_16_ARGS()
    ->UseManualTime();
BENCHMARK_TEMPLATE(ORIGINAL_CUB_WARP_SEGMENTED_PREFIXSUM, 128, 16)
    ->SEG_16_ARGS()
    ->UseManualTime();
BENCHMARK_TEMPLATE(ORIGINAL_CUB_WARP_SEGMENTED_PREFIXSUM, 256, 16)
    ->SEG_16_ARGS()
    ->UseManualTime();
BENCHMARK_TEMPLATE(ORIGINAL_CUB_WARP_SEGMENTED_PREFIXSUM, 512, 16)
    ->SEG_16_ARGS()
    ->UseManualTime();
BENCHMARK_TEMPLATE(ORIGINAL_CUB_WARP_SEGMENTED_PREFIXSUM, 1024, 16)
    ->SEG_16_ARGS()
    ->UseManualTime();

BENCHMARK_TEMPLATE(ORIGINAL_CUB_WARP_SEGMENTED_PREFIXSUM, 32, 32)
    ->SEG_32_ARGS()
    ->UseManualTime();
BENCHMARK_TEMPLATE(ORIGINAL_CUB_WARP_SEGMENTED_PREFIXSUM, 64, 32)
    ->SEG_32_ARGS()
    ->UseManualTime();
BENCHMARK_TEMPLATE(ORIGINAL_CUB_WARP_SEGMENTED_PREFIXSUM, 128, 32)
    ->SEG_32_ARGS()
    ->UseManualTime();
BENCHMARK_TEMPLATE(ORIGINAL_CUB_WARP_SEGMENTED_PREFIXSUM, 256, 32)
    ->SEG_32_ARGS()
    ->UseManualTime();
BENCHMARK_TEMPLATE(ORIGINAL_CUB_WARP_SEGMENTED_PREFIXSUM, 512, 32)
    ->SEG_32_ARGS()
    ->UseManualTime();
BENCHMARK_TEMPLATE(ORIGINAL_CUB_WARP_SEGMENTED_PREFIXSUM, 1024, 32)
    ->SEG_32_ARGS()
    ->UseManualTime();
